...
test('chat route is authenticated, per-minute limited, abortable, and server-only without a quota migration dependency', async () => {
  ...
  assert.doesNotMatch(route, /reserveAssistantUsage/);
  assert.doesNotMatch(route, /completeAssistantUsage/);

...
type SetupResolutionStatus = 'idle' | 'complete' | 'incomplete' | 'error';
...
export function AuthGuard({ children }: AuthGuardProps) {
  ...
  }, [authError, authLoading, initialized, isAuthenticated, isPublicRoute, pathname, router]);
  ...
  // Public auth, marketing, legal, and recovery pages stay interactive while
  // the session check runs. They do not need a network round trip to render.
  ...
  if (
    ...
    && (currentSetupStatus === 'idle' || currentSetupStatus === 'incomplete')
  ) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-4">
